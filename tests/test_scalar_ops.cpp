...
TEST_P(TestScalarOps, TestScalarMult) {
    ...
    ASSERT_FLOAT_EQ(b[0], 2.0f);
    ASSERT_FLOAT_EQ(b[1], 4.0f);
    ASSERT_FLOAT_EQ(b[2], 6.0f);
    ASSERT_FLOAT_EQ(b[3], 8.0f);
}
...
TEST_P(TestScalarOps, TestScalarDiv) {
    ...
    ASSERT_FLOAT_EQ(b[0], 0.5f);
    ASSERT_FLOAT_EQ(b[1], 1.0f);
    ASSERT_FLOAT_EQ(b[2], 1.5f);
    ASSERT_FLOAT_EQ(b[3], 2.0f);
}
