...
Currently, the library features optimised matrix multiplication that performs **up to 50x faster** than a naive implementation. 
...
*Screenshots of benchmarks coming soon.*
